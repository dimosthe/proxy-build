...
It deploys a Debian Wheezy server and builds a [Squid proxy](http://www.squid-cache.org/), [SquidGuard](http://www.squidguard.org/index.html) and a [Dashboard](https://github.com/dimosthe/Squid-dashboard) on it.
